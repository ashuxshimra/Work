...
let projects = [
  {
    image: 'textures/tesla.png',
    url: 'https://tesla-1a1cc.web.app/',
  },
  {
    image: 'textures/Food.png',
    url: 'https://mangorestaurant-a8ad5.web.app/',
  },
  {
    image: 'textures/disney.png',
    url: 'https://disney-99eed.web.app/',
  },
  {
    image: 'textures/club.png',
    url: 'https://clubhouseapp-31783.web.app/',
  },
  
  {
    image: 'textures/utils.png',
    url: 'https://textutils-c1859.web.app/',
  }
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Ashutosh Mishra', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Software Engineer / React.JS Developer / Javascript Developer',
      {
        font: font,
        size: 0.018,
        height: 0,
